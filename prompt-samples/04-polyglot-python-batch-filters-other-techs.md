<!--
  Scenario: 04-polyglot-python-batch-filters-other-techs
  ...
  Batch files   : ["services/api/views.py"]
  Batch langs   : ["python"]
  Batch slugs   : ["py-django-view","sql-injection"]
...
- **services/api/views.py**
    - [py-django-view] L33: class-based view
    - [sql-injection] L44: cursor.execute with %-formatted SQL
