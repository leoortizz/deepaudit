<!--
  ...
  Batch slugs   : ["all-server-actions","xss","dangerous-html"]
...
- **app/dashboard/actions.ts**
    - [all-server-actions] L12, 34: Server Action export — investigate auth + ownership
- **app/profile/page.tsx**
    - [xss] L48: dangerouslySetInnerHTML
