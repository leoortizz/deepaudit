<!--
  Scenario: 02-nextjs-tsx-batch
  Typical Next.js + React project, batch of .tsx files. Carries slug notes for the matched candidates.
  Detected tags : ["nextjs","react","node"]
  Batch files   : ["app/dashboard/actions.ts","app/profile/page.tsx"]
  Batch langs   : ["typescript"]
  Batch slugs   : ["all-server-actions","console-log","dangerous-html"]
...
- **app/dashboard/actions.ts**
    - [all-server-actions] L12, 34: Server Action export — investigate rule conformance
- **app/profile/page.tsx**
    - [console-log] L48: console.log(
    - [dangerous-html] L62: innerHTML assignment
