<!--
  ...
  Detected tags : ["nextjs","react","express","fastify","nestjs","hono","django","djangorestframework","fastapi","flask","laravel","rails","gin","echo","fiber","chi","koa","hapi","remix","sveltekit","nuxt","astro","solidstart","graphql","socketio","bullmq","bun","deno","workers","symfony","slim","yii","cakephp","codeigniter","wordpress","drupal","magento","starlette","aiohttp","tornado","sanic","bottle","falcon","celery","airflow","sinatra","grape","hanami","roda","gorilla","buffalo","cobra","actix","axum","rocket","warp","tide","poem","tonic","lambda-rs","spring","ktor","micronaut","jaxrs","dotnet","azure-functions","phoenix","kemal","clojure","erlang","vapor","dart","apex","aws-lambda","gcp-cloud-functions","android","ios"]
  Batch files   : ["infra/Dockerfile"]
  Batch langs   : []
  Batch slugs   : []
...
This repo uses 77 known frameworks: Next.js, React, Express.js, Fastify, NestJS, Hono, Django, Django REST Framework, FastAPI, Flask, Laravel, Ruby on Rails, Gin, Echo, Fiber, Chi, Koa, Hapi, Remix, SvelteKit, Nuxt, Astro, SolidStart, GraphQL, Socket.IO, BullMQ, Bun, Deno, Cloudflare Workers / Edge, Symfony, Slim, Yii, CakePHP, CodeIgniter, WordPress, Drupal, Magento, Starlette, aiohttp, Tornado, Sanic, Bottle, Falcon, Celery, Airflow, Sinatra, Grape, Hanami, Roda, Gorilla mux, Buffalo, Cobra, Actix-web, Axum, Rocket, Warp, Tide, Poem, Tonic (gRPC), Rust AWS Lambda, Spring, Ktor, Micronaut, JAX-RS (Jersey/Quarkus/RESTEasy), .NET / ASP.NET Core, Azure Functions, Phoenix (Elixir), Crystal Kemal, Clojure (Ring/Compojure), Erlang (Cowboy), Swift Vapor, Dart (Shelf), Apex (Salesforce), AWS Lambda, GCP Cloud Functions, Android, iOS. Apply standard auth, input validation, and authorization thinking for each — pay particular attention to cross-framework trust boundaries (one framework's "internal" call is another's public endpoint).
