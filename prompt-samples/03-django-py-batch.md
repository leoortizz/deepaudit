<!--
  Scenario: 03-django-py-batch
  Django project, batch of .py files.
  Detected tags : ["django","python"]
  Batch files   : ["app/views.py","app/settings.py"]
  Batch langs   : ["python"]
  Batch slugs   : ["py-django-view","sql-injection","secrets-exposure"]
...
- **app/views.py**
    - [py-django-view] L22, 41: function-based view (def view(request))
    - [sql-injection] L55: Model.objects.raw with f-string
- **app/settings.py**
