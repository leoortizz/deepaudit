<!--
  Scenario: 09-laravel-php-batch
  Laravel project, batch of .php controller files.
  Detected tags : ["laravel","php"]
  Batch files   : ["app/Http/Controllers/UsersController.php"]
  Batch langs   : ["php"]
  Batch slugs   : ["php-laravel-route","sql-injection","xss"]
...
- `php-laravel-route`: Weak entry-point candidate — confirm the route is outside the `auth` middleware group AND user input reaches a sink before flagging.
...
- **app/Http/Controllers/UsersController.php**
    - [php-laravel-route] L14, 22: Controller class
    - [sql-injection] L31: DB::raw with interpolated input
    - [xss] L48: Blade {!! !!} render
