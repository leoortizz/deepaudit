...
[deepaudit repo](https://github.com/vercel-labs/deepaudit) instead. That
...
| A CWE shape (path traversal, SSRF, prototype pollution) the public set misses | Consider upstreaming to [deepaudit](https://github.com/vercel-labs/deepaudit) |
